// deploy: npx hardhat deploy --network mumbai --tags TokenFactory_Proxy
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// TokenFactory ERC1967Proxy
	{
		...
		const erc20_impl_deployment = await deployments.get("AdvancedERC20_Impl");
		...
		const proxy_init_data = v1_contract.methods.postConstruct(erc20_impl_deployment.address).encodeABI();

		// deploy ERC1967 proxy
		await deployments.deploy("TokenFactory_Proxy", {
...
module.exports.tags = ["TokenFactory_Proxy", "deploy", "v1_0"];
module.exports.dependencies = ["AdvancedERC20_Impl", "TokenFactoryV1"];
