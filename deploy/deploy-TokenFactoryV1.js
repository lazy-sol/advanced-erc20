// deploy: npx hardhat deploy --network mumbai --tags TokenFactoryV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// TokenFactoryV1
	{
		...
		await deployments.deploy("TokenFactoryV1", {
			...
			// args: [erc20_impl_deployment.address],
		...
		const deployment = await deployments.get("TokenFactoryV1");
...
module.exports.tags = ["TokenFactoryV1", "deploy", "v1_0"];
