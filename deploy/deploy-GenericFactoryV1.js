// deploy: npx hardhat deploy --network sepolia --tags GenericFactoryV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// GenericFactoryV1
	{
		...
		await deployments.deploy("GenericFactoryV1", {
		...
		const deployment = await deployments.get("GenericFactoryV1");
...
module.exports.tags = ["GenericFactoryV1", "deploy", "v1_0"];
