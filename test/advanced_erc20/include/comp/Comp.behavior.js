...
function shouldBehaveLikeComp(name, contract_name, symbol, S0, root, a1, a2, a3, a1_pk) {
  ...
  describe('delegateBySig (delegateWithAuthorization)', function() {
    let chainId;
    let Domain;
  ...
  describe('numCheckpoints (votingPowerHistoryLength)', function() {
  ...
  describe('getPriorVotes (votingPowerAt)', function() {
